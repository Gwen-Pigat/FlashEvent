...
use Flash\EventBundle\Entity\Evenement;
use Flash\EventBundle\Form\EvenementType;
...
class EvenementController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FlashEventBundle:Evenement')->findAll();

        return $this->render('FlashEventBundle:Evenement:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('FlashEventBundle:Evenement:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FlashEventBundle:Evenement')->find($id);
        ...
        return $this->render('FlashEventBundle:Evenement:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('FlashEventBundle:Evenement:edit.html.twig', array(
            'entity'      => $entity,
